...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-relation-select', __webpack_require__(4));
  Vue.component('detail-relation-select', __webpack_require__(7));
  Vue.component('form-relation-select', __webpack_require__(10));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        relationLabel: function relationLabel() {
    ...
    ? _c(
        ...
        [
          _c("option", { attrs: { disabled: "" }, domProps: { value: 0 } }, [
            _vm._v("Select a original")
          ]),
          _vm._v(" "),
          _vm._l(_vm.field.options, function(option, index) {
            return _vm.showOptions ||
              option[_vm.field.optionValueKey] == _vm.field.value
              ? _c(
                  "option",
                  {
                    key: index,
                    domProps: { value: option[_vm.field.optionValueKey] }
                  },
                  [
                    _vm._v(
                      "\n        " +
                        _vm._s(option[_vm.field.optionTextKey]) +
                        "\n    "
                    )
                  ]
                )
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TagifyInput__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TagifyInput___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__TagifyInput__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        TagifyInput: __WEBPACK_IMPORTED_MODULE_1__TagifyInput___default.a
    },
    data: function data() {
        var _this = this;

        return {
            selecteds: this.field.value.map(function (item) {
                return item[_this.field.relationLabel];
            })
        };
    },
    ...
    methods: {
        ...
        fill: function fill(formData) {
            var selecteds = this.selecteds.join(",");
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(71), __webpack_require__(32)(module)))
...
/* scopeId */
var __vue_scopeId__ = "data-v-06a9aaa6"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/components/TagifyInput.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-06a9aaa6", Component.options)
  } else {
    hotAPI.reload("data-v-06a9aaa6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(16)("3bb8ceb8", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-06a9aaa6\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./TagifyInput.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-06a9aaa6\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./TagifyInput.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__yaireo_tagify__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__yaireo_tagify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__yaireo_tagify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__yaireo_tagify_dist_tagify_css__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__yaireo_tagify_dist_tagify_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__yaireo_tagify_dist_tagify_css__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {},
    mounted: function mounted() {
        this.tagify = new __WEBPACK_IMPORTED_MODULE_0__yaireo_tagify___default.a(this.$refs.inputRef, {
    ...
    methods: {
        change: function change(e) {
            ...
            try {
                this.$emit('tags-changed', JSON.parse(e.target.value).map(function (tag) {
                    return tag.value;
                }));
            } catch (e) {
                console.error(e);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../css-loader/index.js!./tagify.css", function() {
			var newContent = require("!!../../../css-loader/index.js!./tagify.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-06a9aaa6", module.exports)
  }
}
        ...
        [
          _c("tagify-input", {
            attrs: {
              ...
              name: _vm.field.name,
              value: _vm.selecteds,
              items: _vm.field.options.map(function(item) {
                return item[_vm.relationLabel]
              })
            },
