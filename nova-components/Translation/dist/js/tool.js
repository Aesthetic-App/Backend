...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_primevue_config__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_primevue_config___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_primevue_config__);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_primevue_config___default.a);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        SelectButton: __WEBPACK_IMPORTED_MODULE_0_primevue_selectbutton___default.a
    },
...
Component.options.__file = "node_modules/primevue/selectbutton/SelectButton.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-09b55e0e", Component.options)
  } else {
    hotAPI.reload("data-v-09b55e0e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_ObjectUtils__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_ObjectUtils___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__utils_ObjectUtils__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ripple_Ripple__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ripple_Ripple___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__ripple_Ripple__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getOptionLabel: function getOptionLabel(option) {
            return this.optionLabel ? __WEBPACK_IMPORTED_MODULE_0__utils_ObjectUtils___default.a.resolveFieldData(option, this.optionLabel) : option;
        },
        getOptionValue: function getOptionValue(option) {
            return this.optionValue ? __WEBPACK_IMPORTED_MODULE_0__utils_ObjectUtils___default.a.resolveFieldData(option, this.optionValue) : option;
        },
        getOptionRenderKey: function getOptionRenderKey(option) {
            return this.dataKey ? __WEBPACK_IMPORTED_MODULE_0__utils_ObjectUtils___default.a.resolveFieldData(option, this.dataKey) : this.getOptionLabel(option);
        },
        isOptionDisabled: function isOptionDisabled(option) {
            return this.optionDisabled ? __WEBPACK_IMPORTED_MODULE_0__utils_ObjectUtils___default.a.resolveFieldData(option, this.optionDisabled) : false;
        },
        onOptionSelect: function onOptionSelect(event, option) {
            ...
            if (this.multiple) {
                if (selected) newValue = this.value.filter(function (val) {
                    return !__WEBPACK_IMPORTED_MODULE_0__utils_ObjectUtils___default.a.equals(val, optionValue, _this.equalityKey);
        ...
        isSelected: function isSelected(option) {
            ...
            if (this.multiple) {
                if (this.value) {
                    ...
                    try {
                        for (var _iterator = this.value[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            ...
                            if (__WEBPACK_IMPORTED_MODULE_0__utils_ObjectUtils___default.a.equals(val, optionValue, this.equalityKey)) {
                                selected = true;
                                break;
                            }
                        }
                ...
                selected = __WEBPACK_IMPORTED_MODULE_0__utils_ObjectUtils___default.a.equals(this.value, optionValue, this.equalityKey);
            }
    ...
    directives: {
        'ripple': __WEBPACK_IMPORTED_MODULE_1__ripple_Ripple___default.a
    }
});
...
var _DomHandler = _interopRequireDefault(__webpack_require__(23));
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "p-selectbutton p-buttonset p-component",
      attrs: { role: "group" }
    },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-09b55e0e", module.exports)
  }
}
              ...
              _c(
                ...
                [
                  _c(
                    "div",
                    {
                      staticClass: "card-body py-3 d-flex flex-col",
                      class: { "new-message": !_vm.messages[index] },
                          ...
                          directives: [
                            {
                              ...
                              rawName: "v-model",
                              value:
                                _vm.messagesModel[index].messages[
                                  _vm.selectedLocale
                                ],
                              expression:
